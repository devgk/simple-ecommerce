    ...
    <div class="col-12">
      ...
      <li class="list-group-item d-flex justify-content-between lh-condensed">
        <div>
          <table>
            <tr>
              <td><img style="height: 50px;" src="{{ Storage::url('public/'.$order->product_image) }}"></td>
              <td>
                <div class="pe-3">
        ...
        <div>
          ...
          <div>
            <a class="text-decoration-none" href="{{ route('admin.manageOrder', $order) }}"><strong>Manage Order</strong></a>
          </div>
        </div>
      </li>
      </ul>
